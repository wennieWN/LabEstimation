<!-- 登陆文件 -->
<template>
  <div class="editreport_section">
    <Header></Header>

    <div class="editreport_content">
      <div id="directory">
      ...
      <div class="content" >
        ...
        <div align="center" style="margin-top: 20px">
          <el-button type="primary" v-on:click="toGenerate">Save</el-button>
        </div>
  ...
  export default {
    ...
    data: function () {
      return {
        ...
        columns:  [
          {field: 'name', title:'事务名称', width: 100, titleAlign: 'center',columnAlign:'left',isEdit:true,
            isResize:true},
          {field: 'type', title: '事务类型', width: 100, titleAlign: 'center',columnAlign:'left',isEdit:true,
            isResize:true},
          {field: 'file', title: '逻辑文件', width: 100, titleAlign: 'center',columnAlign:'left',isEdit:true,
            isResize:true},
          {field: 'det', title: 'DET', width: 100, titleAlign: 'center',columnAlign:'left',isEdit:true,
            isResize:true},
          {field: 'complex', title: '复杂度', width: 100, titleAlign: 'center',columnAlign:'left',isEdit:true,
            isResize:true},
          {field: 'ufp', title: 'UFP', width: 100, titleAlign: 'center',columnAlign:'left',isEdit:true,
            isResize:true}
    ...
    methods: {
      ...
      toGenerate () {
        this.$router.push({path: '/generatereport'});
...
<style>
  ...
  .editreport_content > .el-input {
    margin: 5px;
  }

  .editreport_content > .el-button {
    width: 100%;
    margin: 8px 5px;
  }
